...
class NetworkPreprocessingConfig:
    ...
    def from_args(args: Any) -> "NetworkPreprocessingConfig":
        return NetworkPreprocessingConfig(
            ...
            max_triplets=(None if getattr(args, "network_preprocessing_max_triplets", None) == 0 else getattr(args,
                                                                                                              "network_preprocessing_max_triplets",
                                                                                                              None)),
            ...
            output_subdir=str(getattr(args, "network_preprocessing_output_subdir", "networkpruning")),
...
class IdentifiabilityDiagnostics:
    retained_param_mask: jax.Array;
    group_id: jax.Array;
    local_rank_estimate: int
    redundancy_score: jax.Array;
    design_column_norm: jax.Array
